 ...
 * "Andrés Jácome Pazmiño" → "Familia Jácome Pazmiño"
    ...
    <form action={action} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={field}>
          ...
          <input
            name="familyName" style={input} placeholder="Ej: Familia Jácome Pazmiño" required
        ...
        <div style={field}>
          ...
          <input
            name="familySlug" style={input} placeholder="familia-jacome-pazmino" required
            pattern="[a-z0-9-]+"
            onInput={e => { (e.currentTarget as HTMLInputElement).dataset.edited = '1' }}
          />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={field}>
          ...
          <input
            name="adminName" style={input} placeholder="Ej: Andrés Jácome Pazmiño" required
