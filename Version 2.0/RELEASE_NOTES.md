...
The view is per-user — when a Jácome Pazmiño logs in, they see Jácome on the left and Pazmiño on the right; a Rubio Pazmiño logged in sees Rubio on the left and Pazmiño on the right.
